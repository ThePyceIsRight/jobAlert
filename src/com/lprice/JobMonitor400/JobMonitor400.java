...
import static com.lprice.JobMonitor400.as400Handler.*;
import static com.lprice.JobMonitor400.lputils.print;
import static com.lprice.JobMonitor400.lputils.printBorder;
...
public class JobMonitor400 implements ActionListener, ComponentListener {
...
//        tblActiveSpool.setBorder(BorderFactory.createLineBorder(Color.RED));
        ...
        scrollActive.setPreferredSize(new Dimension(width, 200)); // Set preferred size here
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                print("user clicked tab: " + tabName);
                if (index == 0) {
                    tblInactiveSpool.clearSelection();
                } else if (index == 1) {
                    tblActiveSpool.clearSelection();
                }
            }
        });
    ...
    public class submitListener implements ActionListener {
        public String[] getRowValue(JTable tbl){

            int iRow = tblActiveSpool.getSelectedRow();
            jobName = tblActiveSpool.getValueAt(iRow, 0).toString();
            jobNumber = tblActiveSpool.getValueAt(iRow, 1).toString();

            Arrays.fill(jobAttr, null); // clear array before assigning the newly selected values
        ...
        public void actionPerformed(ActionEvent e) {
            if (tblActiveSpool.getSelectedRow() != -1){
                getRowValue(tblActiveSpool);
            } else if (tblInactiveSpool.getSelectedRow() != -1 ){
                getRowValue(tblInactiveSpool);
            }

            MonitorJobsWorker worker = new MonitorJobsWorker(as400, jobName, userName, jobNumber);
            worker.execute();
    ...
    public static void main(String[] args) {
        ...
        printBorder("WELCOME TO JOB MONITOR 400!");
