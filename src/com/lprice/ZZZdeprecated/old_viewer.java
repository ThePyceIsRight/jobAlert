...
public class old_viewer extends JFrame {
    ...
    public old_viewer(AS400 as400) throws PropertyVetoException, AS400SecurityException, ObjectDoesNotExistException, IOException, InterruptedException, ErrorCompletingRequestException {
...
//        }
    ...
    public void jobAlert() throws AS400SecurityException, ObjectDoesNotExistException, IOException, InterruptedException, ErrorCompletingRequestException, PropertyVetoException {
        ...
        */
        ...
        // Run the task
        old_viewer myTableDialog = new old_viewer(as400);
